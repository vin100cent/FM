/*
 ...
 may need to modularize parameter layout class and add to constructor of editor
...
//==============================================================================
VinceSynthAudioProcessor::VinceSynthAudioProcessor()
    ...
    #endif
                       ), apvts (*this, nullptr, "Parameters", createParams()), presetManager(std::make_unique<PresetManager>(apvts))
#endif
    {
    ...
    //==============================================================================
    const juce::String VinceSynthAudioProcessor::getName() const
    {
        return JucePlugin_Name;
    }

    bool VinceSynthAudioProcessor::acceptsMidi() const
    {
    ...
    bool VinceSynthAudioProcessor::producesMidi() const
    {
    ...
    bool VinceSynthAudioProcessor::isMidiEffect() const
    {
#if JucePlugin_IsMidiEffect
        return true;
#else
    ...
    double VinceSynthAudioProcessor::getTailLengthSeconds() const
    {
        return 0.0;
    }

    int VinceSynthAudioProcessor::getNumPrograms()
    {
        return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
            // so this should be at least 1, even if you're not really implementing programs.
    }

    int VinceSynthAudioProcessor::getCurrentProgram()
    {
        return 0;
    }

    void VinceSynthAudioProcessor::setCurrentProgram (int index)
    {
    }

    const juce::String VinceSynthAudioProcessor::getProgramName (int index)
    {
        return {};
    }

    void VinceSynthAudioProcessor::changeProgramName (int index, const juce::String& newName)
    {
    }

    //==============================================================================
    void VinceSynthAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
    {
    ...
    void VinceSynthAudioProcessor::releaseResources()
    {
...
#ifndef JucePlugin_PreferredChannelConfigurations
    bool VinceSynthAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
    {
    #if JucePlugin_IsMidiEffect
    ...
    void VinceSynthAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
    {
    ...
    //==============================================================================
    bool VinceSynthAudioProcessor::hasEditor() const
    {
        return true; // (change this to false if you choose to not supply an editor)
    }

    juce::AudioProcessorEditor* VinceSynthAudioProcessor::createEditor()
    {
        return new VinceSynthAudioProcessorEditor (*this);
    }

    //==============================================================================
    void VinceSynthAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
    {
    ...
    void VinceSynthAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
    {
    ...
    {
        return new VinceSynthAudioProcessor();
    }

    juce::AudioProcessorValueTreeState::ParameterLayout VinceSynthAudioProcessor::createParams()
    {
